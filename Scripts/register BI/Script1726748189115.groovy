...
// WebUI üzerinde JavaScript çalıştırma
String customName = WebUI.executeJavaScript('', null)

// Sonuç olarak oluşturulan customName'i yazdır
println('Generated Custom Name: ' + customName)
...
selenium.select('xpath=//div[@id=\'__next\']/div/main/div/div[2]/form/div[6]/div/div/div/div[2]/div[2]/div/div/div/div/div/div/div[2]/div[2]/select', 
    'label=2000')
...
selenium.select('xpath=//div[@id=\'__next\']/div/main/div/div[2]/form/div[6]/div/div/div/div[2]/div[2]/div/div/div/div/div/div/div[2]/div/select', 
    'label=January')
...
String phoneNumber = selenium.getEval(((((((' var email = "' + email) + '";var sin = "') + sin) + '";var customName = "') + 
    customName) + '";var storedVars = { \'email\': email,\'sin\': sin,\'//The_steps_below_will_empty_the_cart_\': //The_steps_below_will_empty_the_cart_,\'customName\': customName }; ') + 
    'function generateRandomPhoneNumber() { var areaCode = \'(432)\'; var firstPart = Math.floor(100 + Math.random() * 900).toString(); var secondPart = Math.floor(1000 + Math.random() * 9000).toString(); return areaCode + \' \' + firstPart + \'-\' + secondPart; } generateRandomPhoneNumber();')
