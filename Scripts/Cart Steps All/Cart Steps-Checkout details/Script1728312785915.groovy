...
try {
WebUI.comment('59.step de fail, çünkü 56 da get text yapamıyor, Murattan bekliyoruz')
...
WebUI.setText(findTestObject('Object Repository/Cart Steps-Checkout details/Page_Homepage  Farmasi/input_EN_email'), 'siparis3@pinar.com')
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Cart Steps-Checkout details/Page_Men  Farmasi/path'), 5)
...
balancedefaultprice = WebUI.getText(findTestObject('Object Repository/Cart Steps-Checkout details/Page_Checkout  Farmasi/input_1274.45_walletBalance'))
