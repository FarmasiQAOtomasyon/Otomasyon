...
try {
WebUI.comment('41. satır da fail alıyor, Murattan geliştirme bekleniyor get text yapamıyor')
...
WebUI.setText(findTestObject('Object Repository/Cart Steps-Ürün arama_Detay/Page_Homepage  Farmasi/input_EN_email'), 'siparis3@pinar.com')
...
WebUI.verifyElementText(findTestObject('Cart Steps-Ürün arama_Detay/Page_Basket  Farmasi/input_40.00_styles_input__TfQ13'), 
