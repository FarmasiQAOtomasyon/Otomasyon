...
WebUI.switchToWindowUrl('https://preprod.farmasi.ca/farmasi/product-list/makeup?cid=2bf65b5e-60d3-eb11-a315-005056010963')

WebUI.click(findTestObject('Page_Homepage Farmasi Local/Ca Add Cart Steps/Page_Checkout Result  Farmasi/div_CT'))

WebUI.click(findTestObject('Page_Homepage Farmasi Local/Ca Add Cart Steps/Page_Order Detail  Farmasi/span_Sign Out'))

WebUI.waitForPageLoad(2)

WebUI.switchToWindowTitle('Homepage | Farmasi')
