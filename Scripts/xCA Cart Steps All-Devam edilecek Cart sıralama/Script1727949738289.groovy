...
try {
    ...
    WebUI.setText(findTestObject('null'), 'siparis3@pinar.com')
    ...
    WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Search Result for lipstick  Farmasi/AddtoCart-Creamy Lipstick - 01 Country Rose'), 
        0)

    WebUI.click(findTestObject('Object Repository/Page_Search Result for lipstick  Farmasi/AddtoCart-Matte Liquid Lipstick - Merry Berry Celebration'))
    ...
    WebUI.click(findTestObject('Object Repository/Page_Search Result for lipstick  Farmasi/modalCloseButton'))

    WebUI.click(findTestObject('Object Repository/Page_Search Result for lipstick  Farmasi/AddtoCart-BB Glaze Lipstick Neutral Nude 01'))

    WebUI.verifyElementText(findTestObject('Object Repository/Page_Search Result for lipstick  Farmasi/span_Add to Cart'), 
        'Add to Cart')
    ...
    WebUI.verifyElementText(findTestObject('Object Repository/Page_Basket  Farmasi/input_22.90_styles_input__TfQ13'), '3')

    WebUI.click(findTestObject('Object Repository/Page_Basket  Farmasi/svg'))

    WebUI.verifyElementText(findTestObject('Object Repository/Page_Basket  Farmasi/input_22.90_styles_input__TfQ13'), '4')

    WebUI.setText(findTestObject('Object Repository/Page_Basket  Farmasi/input_22.90_styles_input__TfQ13'), '40')

    WebUI.sendKeys(findTestObject('Object Repository/Page_Basket  Farmasi/input_22.90_styles_input__TfQ13'), Keys.chord(
            Keys.ENTER))

    WebUI.verifyElementText(findTestObject('Object Repository/Page_Basket  Farmasi/input_22.90_styles_input__TfQ13'), '40')
    ...
    WebUI.verifyElementText(findTestObject('Object Repository/Page_Wishlist  Farmasi/p_The list successfully deleted'), 
    ...
    WebUI.verifyElementText(findTestObject('Object Repository/Page_Checkout  Farmasi/div_Creamy Lipstick - 14 Scarlet'), 
    ...
    WebUI.verifyElementText(findTestObject('Object Repository/Page_Checkout Result  Farmasi/h4_Thank you for your order'), 
